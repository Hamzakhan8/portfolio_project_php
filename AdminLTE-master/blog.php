...
if (isset($_POST['submit'])) {
  ...
  $result=mysqli_query($conn,"INSERT INTO blog(img,img2,paragraph1,paragraph2,name) VALUES('$logo','$bgimage','$title','$title2','$name')");
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['id']; ?></td>
                           <td><img style="height: 100px;width: 80px;" src="<?php echo $row['img']; ?>"></td>
                        <td><p style="width: 80px;"><?php echo $row['paragraph2']; ?></p></td>
                        <td><p style="width: 80px";> <?php echo $row['paragraph1']; ?></p></td>
                        <td><img style="height: 100px;width: 80px;" src="<?php echo $row['img2']; ?>"></td>
                        <td><p style="width: 80px";> <?php echo $row['name']; ?></p></td>
                       ...
                       <div class="tools">
                           ...
                           <td><a class="btn btn-danger" href="delete.php?delete=<?php echo $row['id'];?>&table=blog&filename=blog.php"><i class="fa fa-trash-o ">Delete</i></a>

                            </td>
                            <td>
                            <a class="btn btn-success" href="blog_update.php?update=<?php echo $row['id'] ?>"><i class="fa fa-edit "> Update</i></a></td>
