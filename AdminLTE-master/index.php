...
if (isset($_POST['submit'])) {
  ...
  $user= mysqli_real_escape_string($conn,htmlentities(trim(strip_tags($_POST['input_user']))));
  $pass= mysqli_real_escape_string($conn,htmlentities(trim(strip_tags($_POST['input_pass']))));
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Password" name="input_pass">
