...
if (isset($_POST['submit'])) {
  ...
  $result=mysqli_query($conn,"INSERT INTO my(name,image,para1) VALUES('$name','$bgimage','$para1')");
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['para1']; ?></td>
                           ...
                           <td><a href="delete.php?delete=<?php echo $row['ID']?>&table=my&filename=my.php">Delete</a>
